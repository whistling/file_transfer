...
type Chunk struct {
	...
	Data      []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`                             // 每个chunk的数据部分
	Offset    int64  `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`                        // 块在文件中的偏移量
	ChunkSize int32  `protobuf:"varint,3,opt,name=chunk_size,json=chunkSize,proto3" json:"chunk_size,omitempty"` // 当前chunk的大小
}
...
type UploadResponse struct {
	...
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`  // 可选的反馈信息
}
...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x72, 0x22, 0x52, 0x0a, 0x05, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61,
	...
	,
...
var file_proto_file_proto_goTypes = []interface{}{
	(*Chunk)(nil),          // 0: file_transfer.Chunk
	(*UploadResponse)(nil), // 1: file_transfer.UploadResponse
}
var file_proto_file_proto_depIdxs = []int32{
	0, // 0: file_transfer.FileTransfer.UploadFile:input_type -> file_transfer.Chunk
	1, // 1: file_transfer.FileTransfer.UploadFile:output_type -> file_transfer.UploadResponse
